...
namespace BethanysPieShop.Module
{
    public class MockPieRepository : IPieRepository
    {
        ...
        public IEnumerable<Pie> Allpies =>
            new List<Pie>
            {
                //new Pie{PieId=1, Name="Strawberry pie",price=15.9m,ShortDescription="lorem",LongDescription="lorem",CategoryName="FruitPie"},
                //new Pie{PieId=2, Name="Cheese cake",price=12.9m,ShortDescription="lorem",LongDescription="lorem",CategoryName="seasonal Pie"},
                //new Pie{PieId=3, Name="Rhubarb Pie",price=22.9m,ShortDescription="lorem",LongDescription="lorem", CategoryName="seasonal Pie"},
                //new Pie{PieId=4, Name="Pumpkin Pie",price=11.9m,ShortDescription="lorem",LongDescription="lorem",CategoryName="seasonal Pie"}
